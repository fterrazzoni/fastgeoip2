...
public class IPv6Address {
    ...
    static public int[] parseIP(String ipStr) {
        ...
        if (lastColonPosition!=-1) {
            ...
            if(ipStr.indexOf(".")!=-1) {
                ...
                // Check the IPv6 part
                int storage[] = parseIPv6(ipStr.substring(0,lastColonPosition)+":0:0");
    ...
    // This method doesn't throw (but returns null in case of failure)
    static public IPv6Address parse(String ip) {
        int[] repr = parseIP(ip);
        if(repr != null) {
            return new IPv6Address(repr);
        }
        return null;
    }
